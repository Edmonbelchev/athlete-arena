...
export default function WorkoutsScreen() {
  ...
  const refresh = useCallback(async (options?: { silent?: boolean }) => {
    ...
    try {
      const nextTemplates = await getMyCustomWorkoutTemplates();
    ...
    <View style={styles.headerContent}>
      ...
      <Pressable
        ...
        <View style={styles.createCopy}>
          <Text style={styles.createTitle}>Create workout</Text>
          <Text style={styles.createBody}>Build a workout, save it, and share with friends.</Text>
        </View>
        <View style={styles.createIconWrap}>
          <AppIcon name="bolt" size={22} color="#FFFFFF" weight="bold" />
        </View>
      </Pressable>
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <WorkoutTemplateCard
            ...
            onEdit={
              item.isOwner ? () => openCreateModal(item.templateId) : undefined
            }
            onDelete={
              item.isOwner

-- Half burpees: friend challenges, goals, stats, daily quest reroll (same tiers as burpees).
...
begin
  ...
  if p_exercise not in ('push_ups', 'squats', 'pull_ups', 'burpees', 'half_burpees') then
